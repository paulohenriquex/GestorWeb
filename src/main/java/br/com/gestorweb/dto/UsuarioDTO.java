...
public record UsuarioDTO(Long id, String email, String senha, String role, List<ProdutoDTO> produtos,
                List<ReceitaDTO> receitas, List<FornecedorDTO> fornecedores, List<ServicoDTO> servicos, // ServicoDTO
                                                                                                        // here refers
                                                                                                        // to the type
                                                                                                        // of service
                List<PlanejamentoDTO> planejamentos, List<MarcaDTO> marcas, List<CategoriaDTO> categorias,
                List<EnderecoDTO> enderecos,
                List<IngredienteReceitaDTO> ingredientes, List<ServicoPlanejamentoDTO> servicosPlanejamento,
